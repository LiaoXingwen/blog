		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="example-navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li class='active'><a href="${path}/admin/released"><i
							class="fa fa-home"></i>已发布</a></li>
	...
	<div class="container">
		<div class="row" align="right"
			...
			<c:forEach var="article" items="${mv.list}">
				<div class="col-xs-12 col-sm-6 col-md-6  col-lg-6 articlediv"
					id='aid-${article.aid}'>
					...
					<p>
						...
						<a type="button" class="btn btn-success "
							href="${path}/admin/cancelpush/${article.aid}"
							role="button">
							<span class="glyphicon glyphicon-export"></span> 取消发布
						</a>
					</p>
				</div>
			</c:forEach>
				...
				<c:forEach var="p" items="${mv.pagers}">
					<c:choose>
						<c:when test="${mv.pager!=p}">
							<button type="button" class="btn btn-success btn-sm"
								onClick="location.href='./released?pager=${p}'">${p}</button>
						</c:when>
						<c:otherwise>
							<button type="button" class="btn btn-success btn-sm"
